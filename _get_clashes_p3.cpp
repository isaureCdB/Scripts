...
static void _cffi_d_get_clashes_p3(int x0, int x1, float x2, double * x3, _Bool * x4)
{
  get_clashes_p3(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_get_clashes_p3(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  float x2;
  ...
  if (!PyArg_UnpackTuple(args, "get_clashes_p3", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x4 = (_Bool *)alloca((size_t)datasize);
...
#else
#  define _cffi_f_get_clashes_p3 _cffi_d_get_clashes_p3
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "get_clashes_p3", (void *)_cffi_f_get_clashes_p3, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_get_clashes_p3 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__get_clashes_p3(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__get_clashes_p3(void) { return NULL; }
#  else
     init_get_clashes_p3(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__get_clashes_p3(void)
{
  return _cffi_init("_get_clashes_p3", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_get_clashes_p3(void)
{
  _cffi_init("_get_clashes_p3", 0x2601, &_cffi_type_context);
}
#endif
