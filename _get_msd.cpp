...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 9), // void()(int, int, int, double *, double *, double *)
...
static void _cffi_d_get_msd(int x0, int x1, int x2, double * x3, double * x4, double * x5)
{
  get_msd(x0, x1, x2, x3, x4, x5);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_get_msd(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "get_msd", 6, 6, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5))
    return NULL;
...
#else
#  define _cffi_f_get_msd _cffi_d_get_msd
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "get_msd", (void *)_cffi_f_get_msd, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_get_msd },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__get_msd(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__get_msd(void) { return NULL; }
#  else
     init_get_msd(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__get_msd(void)
{
  return _cffi_init("_get_msd", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_get_msd(void)
{
  _cffi_init("_get_msd", 0x2601, &_cffi_type_context);
}
#endif
