...
static void _cffi_d_get_clashes(int x0, int x1, float x2, double * x3, _Bool * x4)
{
  get_clashes(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_get_clashes(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  float x2;
  ...
  if (!PyArg_UnpackTuple(args, "get_clashes", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
...
#else
#  define _cffi_f_get_clashes _cffi_d_get_clashes
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "get_clashes", (void *)_cffi_f_get_clashes, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_get_clashes },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__get_clashes(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__get_clashes(void) { return NULL; }
#  else
     init_get_clashes(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__get_clashes(void)
{
  return _cffi_init("_get_clashes", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_get_clashes(void)
{
  _cffi_init("_get_clashes", 0x2601, &_cffi_type_context);
}
#endif
