...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 3), // int()(double *, int(*)[2], int, int *, int, float, int *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 9), // double *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // int(*)[2]
...
/* 10 */ _CFFI_OP(_CFFI_OP_ARRAY, 3), // int[2]
/* 11 */ (_cffi_opcode_t)(2),
};

static int _cffi_d_get_clashes_extra(double * x0, int(* x1)[2], int x2, int * x3, int x4, float x5, int * x6)
{
  return get_clashes_extra(x0, x1, x2, x3, x4, x5, x6);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_get_clashes_extra(PyObject *self, PyObject *args)
{
  double * x0;
  int(* x1)[2];
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "get_clashes_extra", 7, 7, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6))
    return NULL;
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x1 = (int(*)[2])alloca((size_t)datasize);
  ...
  _cffi_restore_errno();
  { result = get_clashes_extra(x0, x1, x2, x3, x4, x5, x6); }
  _cffi_save_errno();
...
#else
#  define _cffi_f_get_clashes_extra _cffi_d_get_clashes_extra
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "get_clashes_extra", (void *)_cffi_f_get_clashes_extra, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_get_clashes_extra },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__get_clashes_extra(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__get_clashes_extra(void) { return NULL; }
#  else
     init_get_clashes_extra(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__get_clashes_extra(void)
{
  return _cffi_init("_get_clashes_extra", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_get_clashes_extra(void)
{
  _cffi_init("_get_clashes_extra", 0x2601, &_cffi_type_context);
}
#endif
